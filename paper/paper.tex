...
float64 arithmetic (\texttt{jax\_enable\_x64=True}).
...
ray-sphere $q$ values) agrees to $9.0 \times 10^{-10}$. These results
confirm that the autodiff chain through collision, Bouzidi streaming,
